...
#i just hard coded it becuase postiron was making it difficult
#projPath <- "C:\\Users\\guill\\Documents\\GitHub\\DATA_622_Project"
...
final_map_data_rf <- final_map_data %>%
  mutate(
    predicted_commute_baseline_rf = predict(rf_fit, newdata = ml_data_scaled),
    predicted_commute_ibx_rf      = predict(rf_fit, newdata = ibx_scenario_data_scaled),
    ibx_commute_relief_rf         = predicted_commute_baseline_rf - predicted_commute_ibx_rf
  )
