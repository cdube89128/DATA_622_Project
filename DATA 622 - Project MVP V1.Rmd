...
final_map_data_rf <- final_map_data %>%
  mutate(
    predicted_commute_baseline_rf = predict(rf_fit, newdata = ml_data_scaled %>% select(-GEOID)),
    predicted_commute_ibx_rf      = predict(rf_fit, newdata = ibx_scenario_data_scaled %>% select(-GEOID)),
