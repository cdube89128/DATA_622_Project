...
# Fit the model against the Commute Rate
lm_fit_standardized <- lm(pct_commute_60p ~ . - GEOID, data = ml_data)  # The minus sign (- GEOID) explicitly means don't use ID as a predictor 
